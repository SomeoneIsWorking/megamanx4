...
THE QUESTION IT EXISTS TO ANSWER: does Mega Man X4 stream code overlays (the way Vagrant Story
streams .PRG modules), or is the boot executable the whole engine?
