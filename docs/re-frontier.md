...
- status: re-partial
- deps: RE-01
- evidence: Retail SLUS_005.61 (SHA-1 213733031136d095ca275d6957695aa25011cfa5): tools/verify_cd_irq.py checks six contract groups. InitPAD builds priority-1 element 0x8013BBF8 with handler 0x800EE274 and verifier 0x800EE2DC; the verifier returns non-zero only for IRQ0. startIntr installs jmp_buf 0x8011CBCC whose live saved RA is 0x800E5194; that continuation calls trapIntr 0x800E5208, whose eleven-slot table starts at 0x8011CB98. CD_init registers 0x800E7944 in slot 2 and that callback drains ready/sync results through 0x8013BA80/0x8013BA78 and updates libcd status. Selftest is 6/6. Exact framework pin ce2c83ad untraced CDC evidence reaches Getstat/Init/Demute/Setmode with every IRQ2 acknowledged. scratch/logs/re04-ce2-thread-boundary-trace.log then records task creation with entry 0x8001D064 and 140 ChangeThread calls from the retail scheduler, while 0x8001D064 and its first callee remain never-called; shared runtime/recomp/threads.cpp implements that B0:0x10 service as a no-op. No synchronous-success override, direct entry dispatch, or polling bypass exists.
- where: psxport.pin; game/recomp_seeds.json; tools/verify_cd_irq.py; game/core/vsync_sync.cpp; scratch/logs/re04-ce2-frame-commit-runtime.log and scratch/logs/re04-ce2-thread-boundary-trace.log (untracked runtime evidence); shared psxport runtime/recomp/bios_interrupt.cpp, hle.cpp, and threads.cpp
