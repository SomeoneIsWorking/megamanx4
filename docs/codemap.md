...
| Everything about the game itself | — | ⬜ | Boot, CD, the player-object system, the projection site, the wait-state timers, pad: **not started.** `docs/re-frontier.md` is the ordered list. |
