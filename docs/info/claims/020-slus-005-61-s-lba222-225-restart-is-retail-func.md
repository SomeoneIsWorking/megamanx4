...
The tracked X4 wait seam and recorded psxport pin are the consumer/configuration this A/B rests on. scratch/logs/re04-baseline-state-watch.log attributes D_801406AC=0xC0 to 0x800E4DB0 at retail RA 0x80014D64 after LBA224; recovered retail control flow gives the 601-iteration budget. The shared candidate reaches 0x8001512C, PlayCapcomLogo, and task 0x8001DAF8; the extracted LBA223 payload matches all 2048 guest bytes.
