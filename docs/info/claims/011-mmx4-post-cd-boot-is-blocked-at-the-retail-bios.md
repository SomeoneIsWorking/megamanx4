...
Retail bytes/generator show func_80012740 receives entry 0x8001D064 and func_80012600 invokes ChangeThread at return address 0x800126AC. scratch/logs/re04-ce2-thread-boundary-trace.log, built against exact framework pin ce2c83ad, records the create call and 140 ChangeThread calls, while both 0x8001D064 and 0x800128B8 remain NEVER CALLED. external/psxport/runtime/recomp/threads.cpp states and implements thread_change as a no-op. Upstream Mednafen PC coverage contains 0x8001D064 but is not used as ordered/state evidence because no fresh true-oracle executable is installed.
